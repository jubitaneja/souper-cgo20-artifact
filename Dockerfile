...
run set -x; \
	...
	&& echo 'ca-certificates vim libc6-dev libgmp-dev cmake time patch ninja-build make autoconf automake libtool golang-go python subversion re2c git gcc g++ libredis-perl p7zip-full' > /usr/src/build-deps \
