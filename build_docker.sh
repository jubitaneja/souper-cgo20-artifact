...
tar cz Dockerfile precision/souper precision/test performance/souper performance/llvm-with-calls-to-souper performance/test | docker build -t artifact-cgo -
